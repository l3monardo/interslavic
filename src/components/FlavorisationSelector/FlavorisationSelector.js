...
export const FlavorisationSelector = () => {
    ...
    return (_jsx(Selector, { className: "flavorisation-selector", options: options, onSelect: onSelect, value: flavorisationType, label: t('flavorisation') }));
};
//# sourceMappingURL=FlavorisationSelector.js.map