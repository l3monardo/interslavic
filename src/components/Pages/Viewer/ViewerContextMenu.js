...
export const ViewerContextMenu = ({ buttonRef, text, googleLink, onClose, formsData }) => {
    ...
    return (_jsxs("div", { className: "context-menu", style: pos ? pos : { opacity: 0 }, ref: contextMenuRef, children: [text && (_jsxs(_Fragment, { children: [_jsx("p", { className: "context-menu__text", children: text }), _jsx(Button, { onClick: onClipboardClick, title: t('viewerCopyToClipboard') })] })), _jsx(Button, { href: googleLink, onClick: onClose, target: "_blank", title: t('viewerOpenCeilInGoogleSheets') }), formsData && (_jsx(Button, { onClick: showDetail, title: getPartOfSpeech(formsData.details) === 'verb' ? t('conjugation') : t('declensions') })), text && (_jsx("span", { className: "context-menu__close muted-color cursor-pointer", onClick: onClose, children: _jsx(ContextMenuCloseIcon, {}) }))] }));
};
//# sourceMappingURL=ViewerContextMenu.js.map