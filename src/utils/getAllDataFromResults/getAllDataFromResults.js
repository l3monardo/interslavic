...
import { getColumnName, parseTsvTable, transposeMatrix, } from 'utils';
const getLineId = (line) => line[0];
export const getAllDataFromResults = (results) => {
    ...
    const data = transposeMatrix(columns);
    return {
        data,
        columns,
        rangesMap,
...
//# sourceMappingURL=getAllDataFromResults.js.map