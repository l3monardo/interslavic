...
export var MODAL_DIALOG_TYPES;
(function (MODAL_DIALOG_TYPES) {
    MODAL_DIALOG_TYPES["MODAL_DIALOG_TRANSLATION"] = "MODAL_DIALOG_TRANSLATION";
    MODAL_DIALOG_TYPES["MODAL_DIALOG_WORD_FORMS"] = "MODAL_DIALOG_WORD_FORMS";
    MODAL_DIALOG_TYPES["MODAL_DIALOG_WORD_ERROR"] = "MODAL_DIALOG_WORD_ERROR";
})(MODAL_DIALOG_TYPES || (MODAL_DIALOG_TYPES = {}));
export function mainReducer(state, { type, data }) {
    switch (type) {
        ...
        case ActionTypes.DICTIONARY_LANGUAGES: {
            ...
            return {
                ...state,
                dictionaryLanguages: dictionaryLanguages.includes(data) ?
        ...
        case ActionTypes.TOGGLE_PAGE: {
            ...
            return {
                ...state,
                enabledPages: enabledPages.includes(data) ?
